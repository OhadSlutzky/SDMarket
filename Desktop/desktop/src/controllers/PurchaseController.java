...
public class PurchaseController {
    ...
    private void addAppliedOfferToOrderAndUpdateCart(Discount.ThenGet.Offer selectedOffer, StoreItem newStoreItemFromOffer) {
       ...
       if (mainController.getIsAnimationEnabled()) { performAnimation(455.0, 675.0, this.itemToAddAnimationLabel, newStoreItemFromOffer, new Double[] {0.0, 0.0, 270.0, -350.0});}
    ...
    private void performAllOnActionAddToCartButtonMethods(StoreItem newStoreItem, Store storeToBuyFrom) {
        ...
        if(mainController.getIsAnimationEnabled()) { performAnimation(425.0, 400.0,this.itemToAddAnimationLabel, newStoreItem, new Double[] {0.0, 0.0, 200.0, 100.0, 300.0, -100.0}); }
